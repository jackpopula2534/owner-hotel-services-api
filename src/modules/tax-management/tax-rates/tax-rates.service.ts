...
export class TaxRatesService {
  ...
  async update(id: string, dto: Partial<CreateTaxRateDto>, tenantId: string) {
    ...
    const updated = await this.prisma.taxRate.update({
      ...
      data: {
        ...
        ...(dto.taxPayableAccountId !== undefined && { taxPayableAccountId: dto.taxPayableAccountId }),
  ...
  async seedDefaults(tenantId: string) {
    const defaults = [
      ...
      { code: 'WHT_IND_1', name: 'WHT Individual 1% (40(2))', type: TaxType.WHT_INDIVIDUAL, rate: 1, whtIncomeType: WhtIncomeType.TYPE_40_2 },
      { code: 'WHT_IND_3', name: 'WHT Individual 3% (40(8))', type: TaxType.WHT_INDIVIDUAL, rate: 3, whtIncomeType: WhtIncomeType.TYPE_40_8 },
      { code: 'WHT_JUR_1', name: 'WHT Juristic 1% (Service)', type: TaxType.WHT_JURISTIC, rate: 1, whtIncomeType: WhtIncomeType.TYPE_40_8 },
      { code: 'WHT_JUR_3', name: 'WHT Juristic 3% (Professional)', type: TaxType.WHT_JURISTIC, rate: 3, whtIncomeType: WhtIncomeType.TYPE_40_3 },
      { code: 'WHT_JUR_5', name: 'WHT Juristic 5% (Rental)', type: TaxType.WHT_JURISTIC, rate: 5, whtIncomeType: WhtIncomeType.TYPE_40_5 },
    ];
    ...
    this.logger.log(`Seeded default tax rates for tenant ${tenantId}: ${results.map((r) => r.code).join(', ')}`);
    return results;
  }
}
